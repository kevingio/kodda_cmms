            ...
            <li class="dropdown notification-list">
                <div class="dropdown notification-list nav-pro-img">
                    <a class="dropdown-toggle nav-link arrow-none waves-effect nav-user" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                        ...
                        <img src="{{ !empty(auth()->user()->avatar) ? Storage::url(auth()->user()->avatar) : asset('assets/images/users/user-4.jpg') }}" alt="user" id="profile-picture" class="rounded-circle">
                    </a>
                    <div class="dropdown-menu dropdown-menu-right profile-dropdown ">
                        ...
                        <a class="dropdown-item" href="javascript: void(0)"><i class="mdi mdi-lock-open-outline m-r-5"></i> Change Password</a>
            ...
            <form id="update-profile-form" enctype="multipart/form-data">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            <img src="{{ asset(!empty(auth()->user()->avatar) ? Storage::url(auth()->user()->avatar) : 'assets/images/default-photo.png') }}" class="image-preview" alt="image-preview">
